...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (7, 'Sara', 'Red', 'sara@mail.com', '$2a$10$yYQaJrHzjOgD5wWCyeksjt1Yv1KEKeqUlYfLZQ1OQvyUrnEcX/rOy', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (8, 'Bob', 'Yellow', 'bob@mail.com', '$2a$10$yYQaJrHzjOgD5wWCyelstm1Yv1KEKeqUlYfLZQ1OQvyUrnEcX/rOy', 2);
...
INSERT INTO tasks (id, name, priority, todo_id, state_id) VALUES (8, 'Task #4', 'MEDIUM', 10, 6);
INSERT INTO tasks (id, name, priority, todo_id, state_id) VALUES (9, 'Task #5', 'MEDIUM', 10, 6);

...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (7, 'Bob', 'Black', 'bob@mail.com', 'bob123@!', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (8, 'Sara', 'Sara', 'sara@mail.com', '$2a$10$rT4u5OxVM8f0/u6pI0pLteQTppWcWE7c415binBlDMceiTtDa.u/m', 1);
